...
public class TopBarPart extends UIPart {
	...
	public static function strings():Array {
		if (Scratch.app) {
			...
			Scratch.app.showAboutMenu(Menu.dummyButton());
		}
		return ['File', 'Edit', 'CSM', 'Tips', 'Duplicate', 'Delete', 'Grow', 'Shrink', 'Block help', 'Offline Editor'];
	}
	...
	protected function addTextButtons():void {
		...
		addChild(aboutMenu = makeMenuButton('CSM',  app.showAboutMenu, true));
	}
